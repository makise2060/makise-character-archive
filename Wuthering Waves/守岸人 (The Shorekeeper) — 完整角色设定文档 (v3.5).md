...
- **【2026-08-13 · v3.5 · 插入官方图】** 将「十四、图片素材」改为「十四、角色图片（来自官方 Wiki）」：移除模板式规则文字，改为从 Wuthering Waves Wiki（Fandom）抓取并插入 7 张官方游戏资产图（立绘 / 卡面 / 资料表 / 唤取立绘 / 待机动画 / 蝴蝶 / 弹琴），以相对路径 `images/xxx` 引用，并标注版权归属 Kuro Games。
- **【2026-08-13 · v3.5 · 扩充】** 扩充「四、守岸人完整背景故事」：依游戏内角色档案、官方 Wiki、百科与社区考据，补全并核实诞生逻辑（必然性 / 锚点 / 共振解构 / 命名）、黑海岸成立与「领导者身后的人」定位、对人类的不解、1.3 主线细节（妮婭之死、噬亡星 / 黑洞、最高权限与重构、告白与「欢迎回家」）、42 天周期时计、K626 号决议伏笔；新增 4.5 资料与考据来源小节。文件版本号维持 v3.5（内容充实，未升版）。
- **【2026-08-13 · v3.5】** 新增「文件更新记录」区块。原文设定内容保持不变，仅于文末追加本记录，用于追踪知识时间、作品版本与后续修订。
  - 补充项：核心定位速览、关系锚点、扮演红线摘要（便于跨会话快速回看）。
